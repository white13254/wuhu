...
public class UpdateInformationFrame {
	...
	private JButton btn;
	private UpdateInformationwork upwork;
	public UpdateInformationFrame() {
		frame=new JFrame("修改重型机械信息");
		l1=new JLabel("编号：");
		l2=new JLabel("名称：");
		l3=new JLabel("类型：");
		l4=new JLabel("重量：");
		...
		upwork=new UpdateInformationwork(this);
...
//		forgetpassword.setBounds(260,130,100,20);
	...
	public UpdateInformationwork getUpwork() {
		return upwork;
	}
	public void setUpwork(UpdateInformationwork upwork) {
		this.upwork = upwork;
	}
}
