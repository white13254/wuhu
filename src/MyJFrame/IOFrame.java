...
public class IOFrame {
	...
	private IOwork addwork;
	
	private JButton btn;
	private JButton btnsear;
	public IOFrame() {
		frame=new JFrame("重型机械管理(IO)");
		l1=new JLabel("编号：");
		l2=new JLabel("名称：");
		l3=new JLabel("类型：");
		l4=new JLabel("重量：");
		...
		t7=new JTextField();
		btn=new JButton("增加");
		btnsear=new JButton("查找");
		
		addwork=new IOwork(this);
...
//		forgetpassword.setBounds(260,130,100,20);
		btn.setBounds(30, 230, 60, 30);
		btnsear.setBounds(130, 230, 60, 30);
		frame.add(l1);
		frame.add(l2);
		frame.add(l3);
		frame.add(l4);
